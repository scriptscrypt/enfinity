<template>
    ...
    <!-- Faq questions are to be added here -->
            ...
            answer="Enfinity is the national level flagship event of Enigma-Ecell NMIT.The day focuses on events thst will make participants aware of the business environment and motivate them to build an innovative start-up"/>
            ...
            answer="You can directly register on Unstop"/>
            ...
            <FaqsVue question="In what mode with the events be held ?"
